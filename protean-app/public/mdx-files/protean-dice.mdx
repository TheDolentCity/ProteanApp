...
Protean RPG uses a combination of the two. Most dice faces have a numerical result that you add together when making a check, but some dice will also have unique symbols with equally unique narrative effects.

Here is the default d12 configuration from Protean RPG:
<!--
<ConfiguredDie 
  die="6" 
  dieTags={["Reliable", "Consistent"]}
...
### Dice Configuration
Now that you understand how the dice faces work, you must also understand 
