...
export default function ProteanDocumentViewer(props) {
  ...
  return (
    <div className="flex flex-col w-full h-full">
      ...
      <div className="flex-grow w-full h-full p-8 whitespace-normal">
...
export function ProteanDocumentTab(props) {
  return (
    <li className={`flex-1 flex h-8 my-auto items-center ${props.isActive ? '' : 'bg-black dark:bg-white bg-opacity-5 dark:bg-opacity-20'} `}>
