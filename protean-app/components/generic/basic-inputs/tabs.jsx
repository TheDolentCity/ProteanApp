      ...
      <div className="flex-none flex w-full items-center border-b border-gray-400 bg-gray-200 dark:border-gray-700"> {
        tabs.map((tab, i) => (
          <div className="flex-1 flex h-6 my-auto items-center">
            ...
            <button key={i} onClick={closeTab(tab.label)} className="flex-none m-1 p-1 my-auto justify-center float-right hover:bg-black hover:bg-opacity-10 dark:hover:bg-white focus:outline-none">
              <VscClose></VscClose>
            </button>
          </div>
        ))}
