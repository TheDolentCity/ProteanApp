...
export default function ProteanAppHeader(props) {
  return (
    <div className="flex-none flex flex-nowrap h-8 px-2 my-auto items-center bg-gray-200 dark:bg-gray-900">
      <button className="flex-none h-full my-auto px-2 justify-center hover:bg-gray-400 focus:outline-none">
    ...
    <Dropdown label="File">
      <Elevation>
        <div className="flex flex-col flex-nowrap bg-gray-200">
          <button className="flex-grow my-auto px-4 py-2 text-left hover:bg-gray-400 focus:outline-none">
            <h5>
              Upload File
            </h5>
          </button>
