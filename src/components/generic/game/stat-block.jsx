...
export default function StatBlock(props) {
  ...
  return (
    <Widget css="col-span-12 col-span shadow bg-gray-100 dark:bg-gray-800">
      <div className="flex flex-col">
        <TextareaAutosize
          value={statBlock?.title}
          rows={1}
          maxRows={100}
          className="input-text-area text-base 3xl:text-2xl font-bold"
            ...
            statBlock?.fields.map((field, index) => (
              <div className="flex items-center">
                ...
                <TextareaAutosize
                  ...
                  rows={1}
                  maxRows={100}
                  className="input-text-area w-full"
