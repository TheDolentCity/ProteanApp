    ...
    <Dialog open={isOpen} onClose={onClose}>
      ...
      <div className="fixed z-10 inset-0 overflow-y-auto">
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div className="inline-block w-1/3 p-4 align-middle rounded text-left overflow-hidden shadow-xl transform transition-all bg-white text-black dark:bg-black dark:text-white">
            <div className="flex w-full pb-4 text-right">
              <Dialog.Title className="flex-grow pb-4 pr-4 text-2xl text-left font-semibold">
                Settings
              </Dialog.Title>
              <button
                onClick={onClose}
